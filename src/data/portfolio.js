...
export const projects = [
  ...
  },
  {
    ...
    github: 'https://github.com/Ujwalgarg2387/Reactjs-firebase-Chatapp',
    live: 'https://github.com/Ujwalgarg2387/Reactjs-firebase-Chatapp/',
    featured: true,
    color: '#7b8fdb',
    icon: '💬',
    year: '2024',
...
export const terminalCommands = {
  ...
  projects: {
    output: [
      ...
      { text: '', type: 'output' },
      { text: '  01. Ecommerce Platform     (React.js, Spring Boot, PostgreSQL)', type: 'success' },
      { text: '  02. CliQ India App         (Java, Flutter, Python, Azure)', type: 'success' },
      { text: '  03. Online Messaging App   (React.js, Firebase, Tailwind CSS)', type: 'success' },
      { text: '  04. Agriculture Crop Predictor ML      (Python, Scikit-learn — 96% acc.)', type: 'success' },
      { text: '  05. Custom Blob Generator  (React.js, Chakra UI, Tailwind CSS)', type: 'success' },
      { text: '', type: 'output' },
