  ...
  return (
    <section className={`py-20 ${isDarkMode ? 'bg-dark-bg text-gray-400' : 'bg-gray-100'}`} id='skills'>
      <div className="flex items-center justify-center mb-20">
        <RiLightbulbFlashFill className={`text-3xl md:text-4xl ${isDarkMode ? 'text-customOrange' : 'text-customBlue'}`} />
        <h2 className={`text-3xl md:text-[40px] ml-2 md:ml-4 font-bold ${isDarkMode ? 'text-customOrange' : 'text-customBlue'}`}>
          Skills & Abilities
        </h2>
      </div>
